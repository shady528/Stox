  ...
  const handleSubmit = (e) => {
    ...
    if (!responseFromAPI) {
      ...
      async function callAPI() {
        try {
          const answer = await getAnswer(inputPrompt, llmConfig);
          setChatLog([
            ...chatLog,
            {
    ...
    <div className="homeWrapper">
      ...
      <div className="mainArea">
        <header>
          ...
          <h1>StockBot</h1>
          <button className="settingsBtn" onClick={() => setShowLLMSettings(true)}>
            <svg width={22} height={22} viewBox="0 0 24 24" fill="none" stroke="#d9d9e3" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
